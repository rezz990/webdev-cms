...
<head>
    ...
    @vite(['resources/css/app.css', 'resources/css/public-dark.css', 'resources/js/app.js'])
    @stack('head')
</head>
    ...
    <header class="site-header">
        <nav class="container nav" aria-label="Navigasi utama">
            <a class="brand" href="{{ route('home') }}" aria-label="Webdev Reza, kembali ke beranda">
                ...
                <span class="brand-copy">{{ $siteSettings['site_name'] ?? 'Webdev Reza' }}<small>WEB & APPLICATION DEVELOPER</small></span>
            </a>
            ...
            <div id="navlinks">
                <a @class(['active' => request()->routeIs('home')]) href="{{ route('home') }}"><span>Beranda</span></a>
