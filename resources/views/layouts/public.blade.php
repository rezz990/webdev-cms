    ...
    <header class="site-header">
        <nav class="container nav" aria-label="Navigasi utama">
            <a class="brand" href="{{ route('home') }}" aria-label="Webdev Reza, kembali ke beranda">
                ...
                <span class="brand-copy">{{ $siteSettings['site_name'] ?? 'Webdev Reza' }}<small>PERSONAL MANGA · VOL. 01</small></span>
            </a>
            ...
            <div id="navlinks">
                <a @class(['active' => request()->routeIs('home')]) href="{{ route('home') }}"><span>Cover<small>BERANDA</small></span></a>
                <a @class(['active' => request()->routeIs('about')]) href="{{ route('about') }}"><span>Chapter 01<small>TENTANG</small></span></a>
                <a @class(['active' => request()->routeIs('projects.*')]) href="{{ route('projects.index') }}"><span>Chapter 02<small>PROJECT</small></span></a>
                <a @class(['active' => request()->routeIs('blog.*')]) href="{{ route('blog.index') }}"><span>Chapter 03<small>TULISAN</small></span></a>
                <a class="nav-cta" href="{{ route('contact') }}"><span>Chapter 04<small>KONTAK</small></span> <b aria-hidden="true">→</b></a>
            </div>
        </nav>
    </header>
